...
```xcode
github "rudderlabs/rudder-sdk-swift" "v1.0.0-beta.5"
```
...
* In **Dependency Rule**, select **Up to Next Major Version** and enter `1.0.0-beta.5` as the value, as shown:
...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "git@github.com:rudderlabs/rudder-sdk-swift.git", from: "1.0.0-beta.5")
    ],
    targets: [
