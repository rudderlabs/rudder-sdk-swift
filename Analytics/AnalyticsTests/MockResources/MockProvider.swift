...
extension MockProvider {
    ...
    static let simpleTrackEvent: TrackEvent = {
        let event = TrackEvent(event: "Track_Event", properties: ["Property_1": "Value1"], options: RudderOption().addCustomContext(["context_key": "context_value"], key: "custom_context"))
        return event
    }()
