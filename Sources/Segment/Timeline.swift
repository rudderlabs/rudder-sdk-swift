...
public class Timeline: Subscriber {
    ...
    @discardableResult
    internal func process<E: Message>(incomingEvent: E) -> E? {
    ...
    internal func applyPlugins<E: Message>(type: PluginType, event: E?) -> E? {
        var result: E? = event
...
internal class Mediator {
    ...
    internal func execute<T: Message>(event: T) -> T? {
        var result: T? = event
...
extension DestinationPlugin {
    ...
    internal func isDestinationEnabled(event: Message) -> Bool {
